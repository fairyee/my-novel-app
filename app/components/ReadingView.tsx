    ...
    <div style={{ position: "fixed", inset: 0, background: "#0d0a14", zIndex: 100, overflowY: "auto", WebkitOverflowScrolling: "touch" }}>
      <div style={{ maxWidth: 480, margin: "0 auto", paddingBottom: 160 }}>
        ...
        <div style={{ padding: "28px 20px" }}>
          ...
          <div style={{ fontSize: 12, color: "#5a4a6a", marginBottom: 28 }}>
            {readingNovel.genre}{readingNovel.tags && ` · ${readingNovel.tags}`}
          </div>
          <div style={{ lineHeight: 2.2, fontSize: 16, color: "#ddd4ee", whiteSpace: "pre-wrap", fontWeight: 300 }}>
      ...
      {/* 하단 버튼 */}
      {isMyNovel && (
        <div style={{ position: "fixed", bottom: 0, left: "50%", transform: "translateX(-50%)", width: "100%", maxWidth: 480, padding: "10px 16px 20px", background: "#0d0a14ee", borderTop: "1px solid #2d2040" }}>
